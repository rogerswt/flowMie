...
#' }
#' @export
create_detector = function(theta_0 = 90, alpha = 60, psi_0 = 90, pol = 1, eta = eta_uniform) {
  detector = list()
...
#' @param alpha_prime The variable angle over the detector (zero on the axis)
#' @param alpha The maximum acceptance angle of the detector
#' @description \code{eta_uniform} models a uniform detector
#' @rdname eta_functions
#' @export
eta_uniform = function(alpha_prime, alpha) {
  1.0
}
...
#' @rdname eta_functions
#' @export
eta_van_der_pol = function(alpha_prime, alpha) {
