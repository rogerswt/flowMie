...
Please note that as of now the detector aperture is assumed to be round disk.  Oddly, the laser wavelength isn't modeled here, in the detector, but rather in the particle (due to the organization of objects in Rscattnlay).
